...
for data_name in ["mnist", "spam"]:
    ...
    for field in fields:
        ...
        expected_shape = EXPECTED_SHAPES[data_name][field]
        actual_shape = data[field].shape
        assert EXPECTED_SHAPES[data_name][field] == data[field].shape, "{} field of {} is wrong shape!\Expected {} but got {}".format(field, data_name, expected_shape, actual_shape)
print("All Good!")